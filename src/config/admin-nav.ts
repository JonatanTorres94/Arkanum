...
// renders navigation.
export type AdminNavDomain = "crm" | "clients" | "delivery" | "support" | "system";
...
export const ADMIN_NAV_DOMAIN_ORDER: readonly AdminNavDomain[] = ["crm", "clients", "delivery", "support"];
